...
> **🔢 Calculate your FI number:** Use the [FIRE Number Calculator](/tools/fire-number-calculator?utm_source=blog&utm_medium=internal_cta&utm_campaign=blog_to_tool&utm_content=coastfire-explained&utm_term=fire-number-calculator) to find your exact retirement target based on spending, withdrawal rate, and timeline.
...
> **🎯 Grade your current plan:** The [Retirement Readiness Score](/tools/retirement-readiness-score?utm_source=blog&utm_medium=internal_cta&utm_campaign=blog_to_tool&utm_content=coastfire-explained&utm_term=retirement-readiness-score) scores your bridge plan across withdrawal rate, account access, healthcare, and sequence risk — useful whether you're at CoastFIRE or still building toward it.
...
> **🧮 Find your bridge gap:** If you're planning to retire before 65, the [Taxable Gap Calculator](/tools/taxable-brokerage-gap-calculator?utm_source=blog&utm_medium=internal_cta&utm_campaign=blog_to_tool&utm_content=coastfire-explained&utm_term=taxable-brokerage-gap-calculator) shows how much accessible money you need in taxable accounts to cover the years between early retirement and 59½.
