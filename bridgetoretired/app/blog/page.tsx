      ...
      <div className="max-w-7xl mx-auto px-5 py-16">
        ...
        {featured && (
          <div className="mb-14">
            ...
            <Link href={featured.url} className="group block bg-ink border border-white/[0.07] rounded-xl overflow-hidden hover:border-gold/20 transition-all duration-300">
              <div className="grid md:grid-cols-[1fr_1.4fr]">
                <div className="h-56 md:h-full bg-[radial-gradient(ellipse_70%_60%_at_30%_50%,rgba(232,184,75,0.1),transparent)] bg-slate flex items-center justify-center relative overflow-hidden">
                ...
                <div className="p-8 md:p-10">
                  ...
                  <p className="text-white/50 text-[14px] leading-[1.75] mb-6">
