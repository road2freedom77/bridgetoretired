      ...
      <div className="max-w-4xl mx-auto px-5 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
          ...
          <div className="bg-ink border border-gold/25 rounded-2xl p-7 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <a href="https://buy.stripe.com/placeholder" className="block text-center bg-gold text-black font-syne font-semibold text-[13px] tracking-wide py-3.5 rounded-lg hover:opacity-90 transition-opacity mb-7">
        ...
        <div className="bg-ink border border-gold/20 rounded-2xl p-10 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <a href="https://buy.stripe.com/placeholder" className="inline-block bg-gold text-black font-syne font-semibold text-[14px] tracking-wide px-10 py-4 rounded-xl hover:opacity-90 transition-opacity mb-4">
              Start Pro — ${billing === 'monthly' ? `${monthlyPrice}/mo` : `${annualPrice}/yr`} →
            </a>
