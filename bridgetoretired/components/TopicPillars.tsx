...
const topics = [
  ...
  },
  {
    ...
    cta:   { label: 'Roth Ladder Calculator →', href: '/tools#roth-ladder' },
  },
  {
    icon:  '📐',
    ...
    cta:   { label: 'SEPP Calculator →', href: '/tools#sepp' },
  },
  {
    icon:  '💵',
    ...
    cta:   { label: 'FIRE Number Calculator →', href: '/tools#fire-number' },
  },
  {
    icon:  '📊',
    ...
    cta:   { label: 'Run Your Projection →', href: '/calculator' },
  },
  {
    icon:  '🏥',
