    ...
    <section id="blog" className="py-24 px-5 bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between gap-5 mb-12 flex-wrap">
          ...
          <Link
            href="/blog"
            className="font-mono text-[11px] tracking-widest uppercase text-white/35 hover:text-white flex items-center gap-2 group transition-colors"
          >
            All Articles
        ...
        {posts.length === 0 ? (
          <div className="bg-ink border border-white/[0.07] rounded-xl p-12 text-center">
            ...
            {featured && (
              ...
              >
                <div className="h-56 bg-slate flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="font-syne font-black text-[110px] text-gold/[0.06] absolute right-3 bottom-0 leading-none">
                    01
                  </div>
                ...
                <div className="p-7">
                  ...
                  <p className="text-white/45 text-[13px] leading-[1.75] mb-5">
            ...
            <div className="flex flex-col gap-4">
              {rest.map(post => (
                <Link
                  key={post.slug}
                  href={`/blog/${post.slug}`}
                  className="group bg-ink border border-white/[0.07] rounded-xl p-5 hover:border-gold/15 hover:translate-x-1 transition-all duration-200"
                >
                  <div className="font-mono text-[8.5px] tracking-widest uppercase text-gold mb-2">
                    {post.category}
                  </div>
